...
export const routes: Routes = [
    ...
    { path: 'loading', component: LoadingPageComponent },
  {
    ...
    children: [
      ...
      { path: 'user-list', component: UserList, canActivate: [RoleGuard], data: {role: 'SuperAdmin'} },
     // { path: 'add-profile', component: AddProfile , canActivate: [RoleGuard], data: { role: 'SuperAdmin' } },
      ...
      { path: 'license-list', component: LicenseList , canActivate: [RoleGuard], data: { role: 'SuperAdmin,Admin' } },
      ...
      { path: 'view-client', component: ViewClient, canActivate: [RoleGuard], data: { role: 'SuperAdmin,Admin' }  },
      ...
      { path: 'add-expenses', component: AddExpenses, canActivate: [RoleGuard], data: { role: 'SuperAdmin,Admin' } },
      { path: 'license-client-list', component:LicenseClientList, canActivate: [RoleGuard], data: { role: 'SuperAdmin,Admin' } },
      { path: 'license-client-flow', component:LicenseClientFlow, canActivate: [RoleGuard], data: { role: 'SuperAdmin,Admin' } },
      { path: 'license-client-flow/:id', component:LicenseClientFlow, canActivate: [RoleGuard], data: { role: 'SuperAdmin,Admin' } },
     ...
     { path: 'manage-clients/:id', component: ManageClients, canActivate: [RoleGuard], data: { role: 'SuperAdmin,Admin'  } },
      { path: 'manage-clients', component: ManageClients , canActivate: [RoleGuard], data: { role: 'SuperAdmin,Admin' } },
      { path: 'has-permission', component: HasPermission , canActivate: [RoleGuard], data: { role: 'SuperAdmin,Admin' } },
      { path: 'manage-client-list', component: ManageClientList, canActivate: [RoleGuard], data: { role: 'SuperAdmin' } },
      { path: 'manage-client-address/:id', component: ManageClientAddress, canActivate: [RoleGuard], data: { role: 'SuperAdmin,Admin' } },
      { path: 'manage-client-address', component: ManageClientAddress, canActivate: [RoleGuard], data: { role: 'SuperAdmin,Admin' } },
